...
class Repository
{
     ...
     * @var callable|null
     */
    protected static mixed $handleUnserializeExceptionsUsing = null;
     ...
     * @return mixed
     */
    public function getHidden($key, mixed $default = null): mixed
    {
     ...
     * @return mixed
     */
    public function pull($key, mixed $default = null): mixed
    {
     ...
     * @return mixed
     */
    public function pullHidden($key, mixed $default = null): mixed
    {
     ...
     * @return $this
     */
    public function add($key, mixed $value = null): static
    {
     ...
     * @return $this
     */
    public function addHidden($key, #[\SensitiveParameter] mixed $value = null): static
    {
     ...
     * @return mixed
     */
    public function remember($key, mixed $value): mixed
    {
        if ($this->has($key)) {
            return $this->get($key);
        }
     ...
     * @return mixed
     */
    public function rememberHidden($key, #[\SensitiveParameter] mixed $value): mixed
    {
     ...
     * @return $this
     */
    public function addIf($key, mixed $value): static
    {
        if (! $this->has($key)) {
            $this->add($key, $value);
        }
     ...
     * @return $this
     */
    public function addHiddenIf($key, #[\SensitiveParameter] mixed $value): static
    {
        if (! $this->hasHidden($key)) {
            $this->addHidden($key, $value);
        }
     ...
     */
    public function push($key, mixed ...$values): static
    {
     ...
     * @throws \RuntimeException
     */
    public function pushHidden($key, mixed ...$values): static
    {
     ...
     * @return bool
     */
    protected function isHiddenStackable($key): bool
    {
        return ! $this->hasHidden($key) ||
